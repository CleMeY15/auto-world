...
3. `TASK-0003-source-registry-contract.md` — DONE; dependency usable only after PR #5 integration and verified main
4. `TASK-0004-connector-sdk-contract.md` — READY after TASK-0003 is merged and verified on `main`
