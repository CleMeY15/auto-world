...
for (const reason of ["SOURCE_WRITE_FAILED", "BACKUP_FAILED", "SOURCE_DISPOSAL_FAILED", "RESTORE_FAILED",
  "RESTORED_READ_FAILED", "RESTORED_OBJECT_MISSING", "RESTORED_OBJECT_MISMATCH"]) {
  PUBLIC_REASONS.add(reason);
}
