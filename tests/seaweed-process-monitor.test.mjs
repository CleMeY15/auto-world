...
test("process monitor accepts only bounded measurement evidence and fails closed on invalid markers", () => {
  for (const reason of [
    "seaweed_measure_stat_stdout_exit_1_attempt_1", "seaweed_measure_stat_stderr_exit_255_attempt_1",
  ...
  for (const reason of [
    ...
    "seaweed_measure_du_work_exit_0_attempt_1", "seaweed_measure_stat_stderr_exit_255_attempt_2",
    "seaweed_measure_du_work_root_invalid_attempt_1_other", "seaweed_measure_du_work_exit_1_attempt_1_classifier_failed",
    "seaweed_measure_du_work_invalid_output_attempt_1_not_found",
